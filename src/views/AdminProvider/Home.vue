...
export default {
  ...
  methods: {
    async saveProduct() {
      try {
        await clientAxios.post("providers", this.form);
    ...
    async deleteItem(id) {
      try {
        await clientAxios.delete(`providers/${id.actions}`);
        this.snackbar.show = true;
        this.snackbar.color = "success";
    ...
    async editItem(id) {
      try {
        let res = await clientAxios.get(`providers/${id.actions}`);
        this.dialog = true;
        this.btnEdit = false;
    ...
    async update() {
      ...
      try {
        await clientAxios.put(`providers/${this.providerId}`, temp);
        this.snackbar.show = true;
